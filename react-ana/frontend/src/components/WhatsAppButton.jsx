...
function WhatsAppButton({
  numero = "573001234567", // ⚠️ Reemplaza por el número real de Sweet Ice (código país + número, sin +)
  mensaje = "Hola, quiero más información sobre Sweet Ice 🍦",
}) {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 left-6 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-4 text-white shadow-lift transition-all hover:-translate-y-0.5 hover:shadow-xl sm:bottom-8 sm:left-8"
    >
      <svg
        viewBox="0 0 24 24"
