    ...
    <div>
      ...
      <main className="bg-cream">
        <section className="mx-auto flex max-w-2xl flex-col items-center gap-4 px-6 pb-10 pt-24 text-center sm:px-10">
          ...
          <h1 className="text-4xl font-semibold">Descubre nuestros helados</h1>
          <p className="text-lg text-choco-soft">
            Tenemos sabores para todos los gustos.
          </p>

          {!estaLogueado && (
            <p className="rounded-2xl border border-caramel-soft bg-caramel-soft/40 px-4 py-2 text-sm font-semibold text-caramel-deep">
              Inicia sesión para agregar helados a tu carrito 🍦
            </p>
          )}
        </section>

        {cargandoProductos && (
          <p className="pb-16 text-center text-choco-soft">Cargando sabores…</p>
        )}
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-caramel text-2xl text-white shadow-lift transition-all hover:-translate-y-1 hover:bg-caramel-deep"
      >
        🛒
        {totalItems > 0 && (
          ...
          >
            ...
            {!estaLogueado ? (
              ...
              <p className="py-10 text-center text-choco-soft">
                Todavía no has agregado ningún helado 🍨
              </p>
            ) : (
              <>
